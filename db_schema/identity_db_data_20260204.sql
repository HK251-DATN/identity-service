...
\restrict hWEgA9aigGnlccvgXnem4KL1oS42p44xqqAidJTP3j0lkUkU4i7NYyr4nPDcORi
...
SELECT pg_catalog.setval('public.group_permission_grp_per_id_seq', 8, true);
...
SELECT pg_catalog.setval('public.permissions_per_id_seq', 8, false);
...
SELECT pg_catalog.setval('public.user_group_user_group_id_seq', 1, true);
...
\unrestrict hWEgA9aigGnlccvgXnem4KL1oS42p44xqqAidJTP3j0lkUkU4i7NYyr4nPDcORi
