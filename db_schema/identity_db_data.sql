...
ALTER TABLE public.group_permission
ALTER COLUMN grp_per_id
ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.group_permission_grp_per_id_seq START
    WITH
...
ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.groups_group_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER COLUMN per_id
ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.permissions_per_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.user_group_user_group_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.users_user_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
SELECT pg_catalog.setval (
        'public.group_permission_grp_per_id_seq', 51, true
    );
...
SELECT pg_catalog.setval (
        'public.permissions_per_id_seq', 16, true
    );
...
SELECT pg_catalog.setval (
        'public.user_group_user_group_id_seq', 15, true
    );
